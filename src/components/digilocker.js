(function () {
  ...
  var CONSTANTS = {
      ...
      EXCEPTIONS: {
          MISSING_CONSTRUCTOR_CONFIG: {
              message: "Digio constructor requires configuration options for initdgialization."
          },
          INVALID_ENVIRONMENT: {
  ...
  var digioHandle = window.DigiLocker = function (t) {
      //console.log(param);
      //return false;
      if (!t) {
  ...
  digioHandle.prototype = {
      ...
      submitdg: function (ids, identifier, token_id) {
          try {
